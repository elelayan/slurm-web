...
require.config({
  paths: {
    ...
    'jquery-tablesorter': '/javascript/jquery-tablesorter/jquery.tablesorter',
    'jquery-flot': '/javascript/jquery-flot/jquery.flot',
    'jquery-flot-pie': '/javascript/jquery-flot/jquery.flot.pie',
    xdomain: '../../js/libraries/xdomain',
    async: '/javascript/async/async',
    ...
    'bootstrap-tagsinput': '/javascript/bootstrap/js/bootstrap-tagsinput',
    d3: '/javascript/d3/d3',
